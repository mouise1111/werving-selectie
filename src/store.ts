...
const GEBRUIKERS: Gebruiker[] = [
  ...
  },
  {
    ...
    rol: "recruiter",
    departementId: "dep1",
    departementIds: ["dep1", "dep2"],
  }, // werkt over meerdere departementen (Aanname 6)
...
const VACATURES: Vacature[] = [
  {
    ...
    recruiterId: "rec1",
    beschrijving:
      "Wij zoeken een ervaren frontend developer met kennis van React en TypeScript voor ons groeiend team.",
    vereisten:
      "5+ jaar ervaring met React, TypeScript, CSS. Ervaring met design systems is een plus.",
  ...
  },
  {
    ...
    recruiterId: "rec1",
    beschrijving:
      "Een junior positie voor iemand die wil groeien in backend development met Node.js en databases.",
    vereisten:
      "Basiskennis van JavaScript/TypeScript, SQL. Afgestudeerd in informatica of gelijkwaardig.",
  ...
  },
  {
    ...
    recruiterId: "rec2",
    beschrijving:
      "Verantwoordelijk voor onze digitale marketingcampagnes en social media strategie.",
    vereisten:
      "3+ jaar ervaring in digital marketing, SEO/SEA, Google Analytics.",
    motivatiebriefVerplicht: true,
    status: "open",
  },
  {
    ...
    recruiterId: null,
    beschrijving:
      "We zoeken een DevOps engineer voor CI/CD pipelines en cloud infrastructuur.",
    vereisten:
      "Ervaring met Docker, Kubernetes, AWS of Azure. Linux kennis vereist.",
    motivatiebriefVerplicht: false,
    status: "concept",
  },
];
...
const SOLLICITATIES: Sollicitatie[] = [
  {
    ...
    sollicitantId: "sol1",
    cvTekst:
      "Ahmed El Amrani — 6 jaar ervaring als frontend developer. Gewerkt bij TechCorp en WebStudio. Expertise in React, Vue, TypeScript, en design systems. Master Informatica aan KU Leuven.",
    motivatiebrief:
      "Ik ben zeer gemotiveerd om bij te dragen aan jullie team. Mijn ervaring met React en design systems sluit perfect aan bij deze functie.",
    status: "interview_gepland",
    beoordelingRecruiter: "geschikt",
    opmerkingRecruiter:
      "Sterk profiel, goede match met vereisten. Ervaring met design systems is een groot pluspunt.",
    testResultaat: "",
  ...
  },
  {
    ...
    sollicitantId: "sol2",
    cvTekst:
      "Lisa Janssens — 3 jaar ervaring als full-stack developer. Gewerkt bij StartupBE. Kennis van React, Node.js, PostgreSQL. Bachelor Toegepaste Informatica aan Howest.",
    motivatiebrief:
      "Hoewel ik minder ervaring heb dan gevraagd, ben ik een snelle leerder en heb ik al met React gewerkt in productie.",
    status: "uitgenodigd_voor_test",
    beoordelingRecruiter: "twijfelgeval",
    opmerkingRecruiter:
      "Minder ervaring dan gevraagd, maar toont potentieel. Online test aanbevolen.",
    testResultaat: "",
    interviewBeoordelingen: [],
  },
  {
    ...
    sollicitantId: "sol4",
    cvTekst:
      "Emma De Smedt — 1 jaar ervaring als junior developer. Stage bij WebAgency. Basiskennis HTML, CSS, JavaScript. Bachelor Multimedia aan Erasmushogeschool.",
    motivatiebrief:
      "Ik wil graag doorgroeien naar een senior positie en denk dat jullie bedrijf de juiste plek is.",
    status: "afgewezen",
    beoordelingRecruiter: "niet_geschikt",
    opmerkingRecruiter:
      "Profiel sluit niet aan bij senior vereisten. Onvoldoende React ervaring.",
    testResultaat: "",
    interviewBeoordelingen: [],
  },
  {
  ...
  },
  {
    ...
    sollicitantId: "sol3",
    cvTekst:
      "Pieter Van Damme — 4 jaar ervaring in digital marketing. Gewerkt bij MediaHouse en AdVenture. Expertise in SEO, Google Ads, social media. Master Communicatiewetenschappen aan UGent.",
    motivatiebrief:
      "Met mijn uitgebreide ervaring in digitale marketing ben ik ervan overtuigd dat ik een meerwaarde kan zijn voor jullie team.",
  ...
  },
  {
    ...
    sollicitantId: "sol5",
    cvTekst:
      "Youssef Benzarti — 2 jaar ervaring als marketing assistant. Gewerkt bij RetailPlus. Kennis van social media, content creatie, basis SEO. Bachelor Marketing aan Thomas More.",
    motivatiebrief:
      "Ik ben heel enthousiast over deze kans en wil mijn carriere in digital marketing verder uitbouwen.",
    status: "ontvangen",
    beoordelingRecruiter: null,
    opmerkingRecruiter: "",
    testResultaat: "",
...
function loadState(): AppState {
  try {
    ...
    if (raw) {
      ...
      if (
        parsed.gebruikers?.[0] &&
        typeof parsed.gebruikers[0].departementId !== "string"
      ) {
        return defaultState();
      }
      return parsed;
...
export function statusVariant(
  ...
  switch (status) {
    ...
    case "ingetrokken":
      return "error";
    case "uitgenodigd_voor_test":
    case "interview_gepland":
      return "info";
    case "in_behandeling":
    case "test_voltooid":
    case "shortlist":
    case "interview_afgerond":
      return "warning";
    default:
      return "neutral";
  }
...
// ponytail: all status options for filter dropdowns
export const SOLLICITATIE_STATUS_OPTIONS: {
  value: SollicitatieStatus | "";
  label: string;
}[] = [
  { value: "", label: "Alle statussen" },
  { value: "ontvangen", label: "Ontvangen" },
  { value: "in_behandeling", label: "In behandeling" },
  { value: "uitgenodigd_voor_test", label: "Uitgenodigd voor test" },
  { value: "test_voltooid", label: "Test voltooid" },
  { value: "shortlist", label: "Shortlist" },
  { value: "interview_gepland", label: "Interview gepland" },
  { value: "interview_afgerond", label: "Interview afgerond" },
